...
class PipelineManager {
    ...
    private func checkForLibraryChanges() {
        ...
        do {
            let newDate = try url.resourceValues(forKeys: [.contentModificationDateKey]).contentModificationDate
    ...
    func createRenderPipeline(name: String, descriptor: MTLRenderPipelineDescriptor) throws -> MTLRenderPipelineState {
        do {
    ...
    func getOrCreateComputePipeline(name: String, functionName: String) throws -> MTLComputePipelineState {
