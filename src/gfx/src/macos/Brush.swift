...
@_cdecl("when")
public func when(brush: UnsafeMutableRawPointer?, condition: UnsafeMutableRawPointer?, material: UInt16) -> UnsafeMutableRawPointer? {
...
@_cdecl("distance")
public func distance(point_x: Float, point_y: Float, point_z: Float, min: Float, max: Float) -> UnsafeMutableRawPointer? {
    print("distance (Swift stub)")
    return nil
}

@_cdecl("logical_and")
public func logical_and(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?) -> UnsafeMutableRawPointer? {
    print("logical_and (Swift stub)")
    return nil
}

@_cdecl("logical_or")
public func logical_or(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?) -> UnsafeMutableRawPointer? {
...
@_cdecl("scatter")
public func scatter(base_brush: UnsafeMutableRawPointer?, feature_brush: UnsafeMutableRawPointer?, density: Float, seed: UInt64) -> UnsafeMutableRawPointer? {
    print("scatter (Swift stub)")
    return nil
}

@_cdecl("paint")
public func paint(sdf: UnsafeMutableRawPointer?, size_x: UInt32, size_y: UInt32, size_z: UInt32, brush: UnsafeMutableRawPointer?) -> UnsafeMutableRawPointer? {
