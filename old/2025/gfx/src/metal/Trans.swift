...
@_cdecl("translate")
public func translate(vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float)
...
@_cdecl("rotate")
public func rotate(vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float, angle: Float)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("scale")
public func scale(vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("bias")
public func bias(vol: UnsafeMutableRawPointer?, bias_params: UnsafeRawPointer?)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("flattenBelow")
public func flattenBelow(vol: UnsafeMutableRawPointer?, height: Float, transition: Float)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("amplifyAbove")
public func amplifyAbove(
  vol: UnsafeMutableRawPointer?, height: Float, factor: Float, transition: Float
) -> UnsafeMutableRawPointer? {
...
@_cdecl("join")
public func join(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("cut")
public func cut(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("intersect")
public func intersect(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("blend")
public func blend(a: UnsafeMutableRawPointer?, b: UnsafeMutableRawPointer?, smoothness: Float)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("elongate")
public func elongate(vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float)
  -> UnsafeMutableRawPointer?
{
...
public func displace(
  vol: UnsafeMutableRawPointer?, noise: UnsafeMutableRawPointer?, strength: Float
) -> UnsafeMutableRawPointer? {
...
@_cdecl("warp")
public func warp(vol: UnsafeMutableRawPointer?, noise: UnsafeMutableRawPointer?, strength: Float)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("bend")
public func bend(vol: UnsafeMutableRawPointer?, angle: Float, axis: UInt8)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("twist")
public func twist(vol: UnsafeMutableRawPointer?, strength: Float, axis: UInt8)
  -> UnsafeMutableRawPointer?
{
...
@_cdecl("repeat")
public func repeatVolume(vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float)
  -> UnsafeMutableRawPointer?
{
...
public func repeatLimited(
  vol: UnsafeMutableRawPointer?, x: Float, y: Float, z: Float, count: UInt32
) -> UnsafeMutableRawPointer? {
...
@_cdecl("generate")
public func generate(vol: UnsafeMutableRawPointer?, size_x: UInt32, size_y: UInt32, size_z: UInt32)
  -> UnsafeMutableRawPointer?
{
